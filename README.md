...
It allows creating multiple Facebook profiles and switch between these profiles. New profile creation works by copying the entire app directory (for Facebook that's /data/data/com.facebook.katana) to separate place on device. Profile switch just swaps the current and the 'backup' directories.
